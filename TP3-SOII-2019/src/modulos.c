...
void printPage(struct Modulo modulos[], int cant){
    ...
    "         </li>"
    "        <li class=\"nav-item\">"
    "            <a class=\"nav-link w3-padding-large w3-hide-small text-black-50\" href=\"./modulos.cgi\">Modulos</a>"
    "         </li>"
    "        </ul>"
    "    </div>"
    "    </div>"
    ...
    "        </div>"
    "        </form>"
    "        <iframe name=\"mod-iframe\" class=\"justify-content-center\"  allowtransparency=\"true\" src=\"../scripts/upload.cgi\" frameborder=\"0\" >"
    "        </iframe>"
    "        <p><a class=\"w3-button w3-border w3-large\" href=\"../scripts/remove.sh\">Eliminar modulo</a></p>"
    "        </div>"
    "    </div>"
    "    </div>"
    "</div>"
